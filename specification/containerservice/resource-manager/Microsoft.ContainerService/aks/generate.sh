...
if [[ $OSTYPE == "darwin"* ]]; then
    AKS_PREVIEW_VENDORED_SDK_PATH=${1:-"/Users/fuming/work/azure-cli-extensions/src/aks-preview/azext_aks_preview/vendored_sdks/azure_mgmt_preview_aks"}
else
...
autorest ${SCRIPT_PATH}/readme.md --python --multiapi --version-tolerant=false --python-sdks-folder=${TMP_SDK_PATH} --use=@autorest/python
